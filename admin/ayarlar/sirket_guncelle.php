...
// Sorgu
$sql = "SELECT d.*, u.full_name, u.email, u.profile_photo, u.account_type, u.gender, c.company_name, c.sector
        FROM destek d
...
if ($filter_sector !== '')   $sql .= " AND c.sector = '" . $conn->real_escape_string($filter_sector) . "'";
...
<body>
    ...
    <div class="content">
        ...
        <form method="get" class="filter-box">
            ...
            <input type="text" name="sector" placeholder="Sektör" value="<?= htmlspecialchars($filter_sector) ?>">
                ...
                <div class="info">
                    ...
                    <div class="details">
                        ...
                        <?php if ($d['account_type'] === 'sirket'): ?>
                            ...
                            <strong>Sektör:</strong> <?= htmlspecialchars($d['sector']) ?><br>
                        <?php endif; ?>
